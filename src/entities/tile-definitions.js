...
export const TILE_PROPERTIES = {
    ...
    0: { type: 'empty', solid: false }, // FIX: Tile ID 0 is now correctly defined as non-solid empty space.
    1: { type: 'stone', solid: true }, 2: { type: 'stone', solid: true },
    ...
    130: { type: 'wood', solid: true, collisionBox: { width: 48, height: 16 } },
    131: { type: 'wood', solid: true, collisionBox: { width: 16, height: 16 } },
    152: { type: 'wood', solid: true, collisionBox: { width: 16, height: 48 } },
    153: { type: 'wood', solid: true, collisionBox: { width: 32, height: 32 } },

    196: { type: 'stone', solid: true, collisionBox: { width: 48, height: 16 } },
    197: { type: 'stone', solid: true, collisionBox: { width: 16, height: 16 } },
    218: { type: 'stone', solid: true, collisionBox: { width: 16, height: 48 } },
    219: { type: 'stone', solid: true, collisionBox: { width: 32, height: 32 } },

    238: { type: 'orange_dirt', solid: true, collisionBox: { width: 48, height: 16 } },
    239: { type: 'orange_dirt', solid: true, collisionBox: { width: 16, height: 16 } },

    260: { type: 'orange_dirt', solid: true, collisionBox: { width: 16, height: 48 } },
    261: { type: 'orange_dirt', solid: true, collisionBox: { width: 32, height: 32 } },
