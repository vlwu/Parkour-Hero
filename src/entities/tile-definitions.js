export const TILE_DEFINITIONS = {
  ...
  'b': { type: 'oneway_wood', solid: true, oneWay: true, hazard: false, spriteKey: 'block', spriteConfig: { srcX: 272, srcY: 16, height: 5 }, collisionBox: { width: 48, height: 5 }, description: 'A one-way platform made of wood. The player can jump through it from below.' },
  'c': { type: 'oneway_stone', solid: true, oneWay: true, hazard: false, spriteKey: 'block', spriteConfig: { srcX: 272, srcY: 32, height: 5 }, collisionBox: { width: 48, height: 5 }, description: 'A one-way platform made of stone. The player can jump through it from below.' },
};