...
const staticPlatformDefinitions = {
    ...
    'gold_third_h': { spriteConfig: { srcX: 272, srcY: 128, width: 48, height: 16 }, collisionBox: { width: 48, height: 16 }, oneway: false, surfaceType: 'oneway_gold' },
    'gold_third_v': { spriteConfig: { srcX: 320, srcY: 128, width: 16, height: 48 }, collisionBox: { width: 16, height: 48 }, oneway: false, surfaceType: 'oneway_gold' },
    'gold_ninth_sq': { spriteConfig: { srcX: 272, srcY: 144, width: 16, height: 16 }, collisionBox: { width: 16, height: 16 }, oneway: false, surfaceType: 'oneway_gold' },
    'gold_four_ninths_sq': { spriteConfig: { srcX: 288, srcY: 144, width: 32, height: 32 }, collisionBox: { width: 32, height: 32 }, oneway: false, surfaceType: 'oneway_gold' },
