import{e as r,l as z,c as ue,E as _e,G as Se,a as H,F as we,b as Re,g as Ce}from"./font-renderer-CDR4Oxr_.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Y=globalThis,N=Y.trustedTypes,ae=N?N.createPolicy("lit-html",{createHTML:o=>o}):void 0,ge="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,fe="?"+$,He=`<${fe}>`,S=document,P=()=>S.createComment(""),U=o=>o===null||typeof o!="object"&&typeof o!="function",J=Array.isArray,ze=o=>J(o)||typeof o?.[Symbol.iterator]=="function",W=`[ 	
\f\r]`,L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,re=/-->/g,le=/>/g,k=RegExp(`>|${W}(?:([^\\s"'>=/]+)(${W}*=${W}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),de=/'/g,ce=/"/g,ve=/^(?:script|style|textarea|title)$/i,Be=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),l=Be(1),A=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),pe=new WeakMap,_=S.createTreeWalker(S,129);function xe(o,e){if(!J(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return ae!==void 0?ae.createHTML(e):e}const Ne=(o,e)=>{const t=o.length-1,i=[];let s,n=e===2?"<svg>":e===3?"<math>":"",a=L;for(let c=0;c<t;c++){const d=o[c];let p,u,h=-1,v=0;for(;v<d.length&&(a.lastIndex=v,u=a.exec(d),u!==null);)v=a.lastIndex,a===L?u[1]==="!--"?a=re:u[1]!==void 0?a=le:u[2]!==void 0?(ve.test(u[2])&&(s=RegExp("</"+u[2],"g")),a=k):u[3]!==void 0&&(a=k):a===k?u[0]===">"?(a=s??L,h=-1):u[1]===void 0?h=-2:(h=a.lastIndex-u[2].length,p=u[1],a=u[3]===void 0?k:u[3]==='"'?ce:de):a===ce||a===de?a=k:a===re||a===le?a=L:(a=k,s=void 0);const y=a===k&&o[c+1].startsWith("/>")?" ":"";n+=a===L?d+He:h>=0?(i.push(p),d.slice(0,h)+ge+d.slice(h)+$+y):d+$+(h===-2?c:y)}return[xe(o,n+(o[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class T{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let n=0,a=0;const c=e.length-1,d=this.parts,[p,u]=Ne(e,t);if(this.el=T.createElement(p,i),_.currentNode=this.el.content,t===2||t===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=_.nextNode())!==null&&d.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(const h of s.getAttributeNames())if(h.endsWith(ge)){const v=u[a++],y=s.getAttribute(h).split($),I=/([.?@])?(.*)/.exec(v);d.push({type:1,index:n,name:I[2],strings:y,ctor:I[1]==="."?Fe:I[1]==="?"?We:I[1]==="@"?Ge:F}),s.removeAttribute(h)}else h.startsWith($)&&(d.push({type:6,index:n}),s.removeAttribute(h));if(ve.test(s.tagName)){const h=s.textContent.split($),v=h.length-1;if(v>0){s.textContent=N?N.emptyScript:"";for(let y=0;y<v;y++)s.append(h[y],P()),_.nextNode(),d.push({type:2,index:++n});s.append(h[v],P())}}}else if(s.nodeType===8)if(s.data===fe)d.push({type:2,index:n});else{let h=-1;for(;(h=s.data.indexOf($,h+1))!==-1;)d.push({type:7,index:n}),h+=$.length-1}n++}}static createElement(e,t){const i=S.createElement("template");return i.innerHTML=e,i}}function E(o,e,t=o,i){if(e===A)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl;const n=U(e)?void 0:e._$litDirective$;return s?.constructor!==n&&(s?._$AO?.(!1),n===void 0?s=void 0:(s=new n(o),s._$AT(o,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=E(o,s._$AS(o,e.values),s,i)),e}class De{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??S).importNode(t,!0);_.currentNode=s;let n=_.nextNode(),a=0,c=0,d=i[0];for(;d!==void 0;){if(a===d.index){let p;d.type===2?p=new O(n,n.nextSibling,this,e):d.type===1?p=new d.ctor(n,d.name,d.strings,this,e):d.type===6&&(p=new Ve(n,this,e)),this._$AV.push(p),d=i[++c]}a!==d?.index&&(n=_.nextNode(),a++)}return _.currentNode=S,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class O{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=E(this,e,t),U(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==A&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ze(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&U(this._$AH)?this._$AA.nextSibling.data=e:this.T(S.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=T.createElement(xe(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const n=new De(s,this),a=n.u(this.options);n.p(t),this.T(a),this._$AH=n}}_$AC(e){let t=pe.get(e.strings);return t===void 0&&pe.set(e.strings,t=new T(e)),t}k(e){J(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const n of e)s===t.length?t.push(i=new O(this.O(P()),this.O(P()),this,this.options)):i=t[s],i._$AI(n),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class F{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,n){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=m}_$AI(e,t=this,i,s){const n=this.strings;let a=!1;if(n===void 0)e=E(this,e,t,0),a=!U(e)||e!==this._$AH&&e!==A,a&&(this._$AH=e);else{const c=e;let d,p;for(e=n[0],d=0;d<n.length-1;d++)p=E(this,c[i+d],t,d),p===A&&(p=this._$AH[d]),a||=!U(p)||p!==this._$AH[d],p===m?e=m:e!==m&&(e+=(p??"")+n[d+1]),this._$AH[d]=p}a&&!s&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Fe extends F{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class We extends F{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class Ge extends F{constructor(e,t,i,s,n){super(e,t,i,s,n),this.type=5}_$AI(e,t=this){if((e=E(this,e,t,0)??m)===A)return;const i=this._$AH,s=e===m&&i!==m||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==m&&(i===m||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Ve{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){E(this,e)}}const qe=Y.litHtmlPolyfillSupport;qe?.(T,O),(Y.litHtmlVersions??=[]).push("3.3.1");const ye=(o,e,t)=>{const i=t?.renderBefore??e;let s=i._$litPart$;if(s===void 0){const n=t?.renderBefore??null;i._$litPart$=s=new O(e.insertBefore(P(),n),n,void 0,t??{})}return s._$AI(o),s};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function*w(o,e){if(o!==void 0){let t=0;for(const i of o)yield e(i,t++)}}function x(o){return o===" "?"SPACE":o.startsWith("arrow")?o.replace("arrow","").toUpperCase():o.toUpperCase()}function Q(o=0){const e=Math.floor(o/60),t=o%60,i=Math.floor(t),s=Math.floor((t-i)*1e3);return`${e.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}.${s.toString().padStart(3,"0")}`}class Ye extends b{static properties={fontRenderer:{type:Object},text:{type:String},scale:{type:Number},color:{type:String},outlineColor:{type:String},outlineWidth:{type:Number},align:{type:String}};constructor(){super(),this.text="",this.scale=1,this.color="white",this.outlineColor=null,this.outlineWidth=1,this.align="left"}updated(e){super.updated(e),!(!this.fontRenderer||!this.shadowRoot)&&this.renderCanvas()}renderCanvas(){const e=this.shadowRoot.querySelector("#container");if(!e)return;const t=this.fontRenderer.renderTextToCanvas(this.text,{scale:this.scale,color:this.color,outlineColor:this.outlineColor,outlineWidth:this.outlineWidth,align:this.align});t&&(t.style.imageRendering="pixelated",e.innerHTML="",e.appendChild(t))}render(){return l`<div id="container"></div>`}}customElements.define("bitmap-text",Ye);class Je extends b{static styles=f`
    .keybind-display {
